	...
	class OPanda_SignInLocker_Bounces_StatsTable extends OPanda_StatsTable {
		...
		public function getColumns()
		{
			...
			return array(
				...
				'users' => array(
					'title' => __('Visitors Who', 'bizpanda-signin-locker'),
					'cssClass' => 'opanda-col-common',
					'columns' => array(
						/*
						'ignored' => array(
							'title' => __('Ignored Locker', 'bizpanda-signin-locker'),
							'hint' => __('The number of visitors who viewed the locker but didn\'t try to interact with the one (no clicks on any buttons).', 'bizpanda-signin-locker'),
							'cssClass' => 'opanda-col-number'
						),*/
						'errors' => array(
							'title' => __('Faced Errors', 'bizpanda-signin-locker'),
							'hint' => __('Visitors who faced with any errors and were not able to unlock the content. This value normally should be equal 0. If not, please check settings of your locker or contact OnePress support.', 'bizpanda-signin-locker'),
							'cssClass' => 'opanda-col-number'
						),
						'social-fails' => array(
							'title' => __('Declined Social Apps', 'bizpanda-signin-locker'),
							'hint' => __('Visitors who refused to authorize of your social apps. If you think this value is too large, try to set less social actions to be performed on signing in through social networks.', 'bizpanda-signin-locker'),
							'cssClass' => 'opanda-col-number'
						)
					)
				)
	...
	class OPanda_SignInLocker_Bounces_StatsChart extends OPanda_StatsChart {
		...
		public function getFields()
		{
			...
			return array(
				...
				/*
				'ignored' => array(
					'title' => __('Who Ignored Locker', 'bizpanda-signin-locker'),
					'cssClass' => 'opanda-col-number',
					'color' => '#cccccc'
				),*/
				'errors' => array(
					'title' => __('Who Faced Errors', 'bizpanda-signin-locker'),
					'cssClass' => 'opanda-col-number',
					'color' => '#F97D81'
				),
				'social-fails' => array(
					'title' => __('Who Declined Social Apps', 'bizpanda-signin-locker'),
					'cssClass' => 'opanda-col-number',
					'color' => '#29264E'
				)
			);
